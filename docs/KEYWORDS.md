...
**581 keyword groups** across **128 categories** — **5180 keywords** (English, French, Spanish, German, Italian, Portuguese).
...
| MasterCard | `mastercard`, `master card`, ` mc `, ` mc:`, ` mc-`, `/mc`, `credit card`, `card number`, `card no`, `pan`, `primary account`, `carte de credit`, `carte de crédit`, `compte principal`, `no de carte`, `numero de carte`, `numéro de carte`, `carta di credito`, `cartao de credito`, `cartão de crédito`, `conta principal`, `conto principale`, `cuenta principal`, `hauptkonto`, `karten-nr`, `kartennummer`, `kreditkarte`, `n. carta`, `no de tarjeta`, `no do cartão`, `numero de tarjeta`, `numero della carta`, `numero di carta`, `numero do cartao`, `número de tarjeta`, `número do cartão`, `tarjeta de credito`, `tarjeta de crédito` | 50 |
...
| Finland HETU | `henkilotunnus`, `hetu`, `finnish personal identity`, `personal identity code` | 50 |
...
| Germany Tax ID | `steueridentifikationsnummer`, `identifikationsnummer`, `steuerliche`, `steuer-id`, `tax identification`, `tin`, `steuernummer`, `identification fiscale`, `identificación tributaria`, `identificazione fiscale`, `identificação fiscal`, `steueridentifikation` | 50 |
...
## Financial Crime Reports (13 keyword groups)

| Pattern | Keywords | Distance |
|---|---|---:|
| AUSTRAC Regime | `austrac`, `aml/ctf act`, `ifti`, `international funds transfer`, `designated service`, `money laundering` | 80 |
| AUSTRAC SMR | `austrac`, `smr`, `suspicious matter`, `aml/ctf`, `reporting entity`, `designated service` | 80 |
| AUSTRAC TTR | `austrac`, `ttr`, `threshold transaction`, `aml/ctf`, `10,000`, `physical currency` | 80 |
| FINTRAC EFTR | `fintrac`, `eftr`, `electronic funds transfer`, `reporting entity`, `international`, `10,000` | 80 |
| FINTRAC LCTR | `fintrac`, `lctr`, `large cash transaction`, `reporting entity`, `10,000`, `cash receipt` | 80 |
| FINTRAC STR | `fintrac`, `canafe`, `str`, `pcmltfa`, `reporting entity`, `money laundering`, `terrorist financing` | 80 |
| FINTRAC Terrorist Property Report | `fintrac`, `terrorist property`, `terrorist financing`, `criminal code`, `listed person`, `reporting entity` | 80 |
| FinCEN CTR | `fincen`, `ctr`, `currency transaction`, `cash transaction`, `form 112`, `bank secrecy act` | 80 |
| FinCEN Form 8300 | `form 8300`, `cash payments`, `trade or business`, `irs`, `fincen`, `10,000` | 80 |
| FinCEN SAR | `fincen`, `sar`, `bsa`, `bank secrecy act`, `suspicious activity`, `filing institution`, `31 cfr 1020.320` | 80 |
| Reasonable Grounds To Suspect | `fintrac`, `str`, `suspicious transaction`, `money laundering`, `terrorist financing`, `pcmltfa`, `reporting entity` | 80 |
| SAR Confidentiality Notice | `confidential`, `prohibited from disclosing`, `tipping off`, `shall not disclose`, `unlawful to disclose`, `safe harbor`, `no person shall notify` | 100 |
| UK NCA SAR | `nca`, `ukfiu`, `daml`, `defence against money laundering`, `proceeds of crime act`, `poca`, `consent` | 100 |
...
## Medical Identifiers (5 keyword groups)
...
| Medical Record Number | `mrn`, `medical record`, `patient id`, `patient number`, `chart number`, `medical id`, `health record`, `dossier médical`, `numéro de dossier`, `identifiant patient` | 50 |
...
| Quebec HC | `ramq`, `quebec hc`, `carte soleil`, `quebec health card`, `health insurance quebec`, `carte d'assurance maladie`, `carte assurance maladie`, `numéro d'assurance maladie`, `regie assurance maladie`, `régie de l'assurance maladie` | 50 |
...
## Securities Identifiers (7 keyword groups)

| Pattern | Keywords | Distance |
|---|---|---:|
| CUSIP | `cusip`, `committee on uniform securities`, `security identifier`, `securities identifier`, `bond cusip`, `cusip number`, `settlement`, `clearinghouse`, `dtcc`, `depository trust`, `fixed income`, `bond`, `equity`, `securities`, `instrument`, `ticker`, `position`, `identifier`, `portfolio`, `holding`, `asset`, `issuance`, `prospectus`, `indenture`, `maturity`, `coupon`, `face value`, `par value` | 75 |
...
| SEDOL | `sedol`, `stock exchange daily official list`, `london stock`, `uk securities`, `security code`, `stock code`, `equity`, `shares`, `securities`, `identifier`, `british stock`, `uk equity` | 50 |
| Ticker Symbol | `ticker`, `stock symbol`, `trading symbol`, `nyse`, `nasdaq`, `equity symbol`, `stock ticker` | 50 |
| VALOR | `valor`, `valorennummer`, `valoren`, `six swiss exchange`, `swiss exchange`, `six group`, `ch-isin`, `swiss security`, `swiss securities`, `swissclear` | 50 |
...
## Traffic Light Protocol (6 keyword groups)

| Pattern | Keywords | Distance |
|---|---|---:|
| TLP:AMBER | `tlp`, `traffic light protocol`, `classification`, `marking`, `sharing restriction`, `handling`, `first.org` | 80 |
| TLP:AMBER+STRICT | `tlp`, `traffic light protocol`, `classification`, `marking`, `sharing restriction`, `handling`, `first.org`, `strict` | 80 |
| TLP:CLEAR | `tlp`, `traffic light protocol`, `classification`, `marking`, `public`, `handling`, `first.org` | 80 |
| TLP:GREEN | `tlp`, `traffic light protocol`, `classification`, `marking`, `community`, `handling`, `first.org` | 80 |
| TLP:RED | `tlp`, `traffic light protocol`, `classification`, `marking`, `sharing restriction`, `handling`, `first.org` | 80 |
| TLP:WHITE | `tlp`, `traffic light protocol`, `classification`, `marking`, `public`, `handling`, `first.org` | 80 |
