...
pub async fn init_optional(
    ...
    // One connector for every writer — see siphon_auth::db for the modes.
    // This used to be a private copy of siphon-api's builder, and the two
    // were one edit away from disagreeing about what "TLS on" meant.
